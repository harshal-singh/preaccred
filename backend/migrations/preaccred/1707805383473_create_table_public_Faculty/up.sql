CREATE TABLE "public"."Faculty" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" text NOT NULL, "gender" text NOT NULL, "phoneNo" text NOT NULL, "emailId" text NOT NULL, "dob" date NOT NULL, "panCardNo" text NOT NULL, "address" text NOT NULL, "cast" text NOT NULL, "minority" text NOT NULL, "qualification" text NOT NULL, "experience" text NOT NULL, "designation" text NOT NULL, "dateOfJoining" date NOT NULL, "staffType" text NOT NULL, "section" text NOT NULL, "statusOfApproval" text NOT NULL, "jobType" text NOT NULL, "instituteId" uuid NOT NULL, "createdById" uuid NOT NULL, "updatedById" uuid NULL, "createdAt" timestamptz NOT NULL DEFAULT now(), "updatedAt" timestamptz NOT NULL DEFAULT now(), "status" text NOT NULL DEFAULT 'ACTIVE', "isVerified" boolean NOT NULL DEFAULT false, "cursorId" bigserial  not null unique, PRIMARY KEY ("id"), FOREIGN KEY ("status") REFERENCES "public"."Status"("value") ON UPDATE restrict ON DELETE restrict);
